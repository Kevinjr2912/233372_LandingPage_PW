...
export class DiscographyPageComponent {
  images = [
    ...
    {
      title:'THE SINGLES - VOLUMEN 01',image:'assets/img/TheSinglesVolume01.jpg',content:'Presenta una producción cuidada que resalta la energía y el estilo característico de The Strokes',
      href:'https://open.spotify.com/intl-es/album/2j5jqlI0NvqlXAy9C740pZ?si=e5NMMZpOQ5GyXJI0uSotaA'
    }
  ]

  setCardClass(index: number): string {
    return [1,2,5].includes(index) ? 'box-album-g': 'box-album-b'
  }
}
